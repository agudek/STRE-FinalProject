...
public class Collector_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.jsoup.nodes.Element", false, Collector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jsoup.nodes.Node", false, Collector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jsoup.select.Evaluator", false, Collector_ESTest_scaffolding.class.getClassLoader()));
  }
