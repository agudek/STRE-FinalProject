...
public class SinglelineDetector_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.puppycrawl.tools.checkstyle.checks.regexp.SinglelineDetector"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SinglelineDetector_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.puppycrawl.tools.checkstyle.api.AbstractViolationReporter", false, SinglelineDetector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.puppycrawl.tools.checkstyle.checks.regexp.DetectorOptions", false, SinglelineDetector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.puppycrawl.tools.checkstyle.checks.regexp.MatchSuppressor", false, SinglelineDetector_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SinglelineDetector_ESTest_scaffolding.class.getClassLoader()); 
