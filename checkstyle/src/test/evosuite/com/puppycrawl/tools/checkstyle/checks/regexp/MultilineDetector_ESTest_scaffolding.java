...
public class MultilineDetector_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.puppycrawl.tools.checkstyle.checks.regexp.MultilineDetector"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MultilineDetector_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.puppycrawl.tools.checkstyle.api.AbstractViolationReporter", false, MultilineDetector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.puppycrawl.tools.checkstyle.checks.regexp.DetectorOptions", false, MultilineDetector_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MultilineDetector_ESTest_scaffolding.class.getClassLoader()); 
