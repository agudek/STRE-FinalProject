...
public class AvoidEscapedUnicodeCharactersCheck_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.puppycrawl.tools.checkstyle.checks.AvoidEscapedUnicodeCharactersCheck"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AvoidEscapedUnicodeCharactersCheck_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AvoidEscapedUnicodeCharactersCheck_ESTest_scaffolding.class.getClassLoader()); 
