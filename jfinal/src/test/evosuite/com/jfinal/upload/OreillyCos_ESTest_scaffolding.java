...
public class OreillyCos_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.jfinal.upload.OreillyCos"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OreillyCos_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.jfinal.upload.OreillyCos",
      "com.oreilly.servlet.MultipartRequest"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OreillyCos_ESTest_scaffolding.class.getClassLoader()); 
