...
public class NameSpaceDirective_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.jfinal.plugin.activerecord.sql.NameSpaceDirective"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NameSpaceDirective_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.jfinal.plugin.activerecord.sql.NameSpaceDirective",
      "com.jfinal.template.source.ISource"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(NameSpaceDirective_ESTest_scaffolding.class.getClassLoader()); 
