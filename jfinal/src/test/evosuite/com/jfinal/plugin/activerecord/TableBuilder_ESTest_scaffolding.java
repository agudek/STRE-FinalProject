...
public class TableBuilder_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.jfinal.plugin.activerecord.TableBuilder"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TableBuilder_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.jfinal.plugin.activerecord.TableBuilder",
      ...
      "com.jfinal.plugin.activerecord.JavaType$1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TableBuilder_ESTest_scaffolding.class.getClassLoader()); 
