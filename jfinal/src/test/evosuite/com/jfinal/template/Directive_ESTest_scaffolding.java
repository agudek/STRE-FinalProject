...
public class Directive_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.jfinal.template.Directive"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Directive_ESTest_scaffolding.class.getClassLoader() ,
      "com.jfinal.kit.ElKit$InnerEvalDirective",
      ...
      "com.jfinal.template.ext.directive.NowDirective"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Directive_ESTest_scaffolding.class.getClassLoader()); 
